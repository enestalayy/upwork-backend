...
async function sendNewJobsEmail(newJobs) {
  ...
  let jobListHtml = newJobs
    ...
    <li>
      ...
      ${job.paymentVerified ? "Payment Verified" : "Payment NOT Verified"} <br/>
      Client Rating: ${job.clientRating}/5  <br/>
      Client Spent: ${job.clientSpent} <br/>
      Client Country: ${job.clientCountry} <br/>
